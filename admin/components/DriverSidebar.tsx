...
import { LayoutDashboard, PackageCheck, Clock, DollarSign, LogOut, Sun, Moon, UserCircle } from "lucide-react";
...
const navItems = [
    ...
    { name: "Active Deliveries", href: "/driver/deliveries", icon: PackageCheck },
...
export function DriverSidebar({ onClose }: DriverSidebarProps) {
    ...
    return (
        <div className="flex h-screen w-64 flex-col border-r bg-white dark:bg-zinc-900 dark:border-zinc-800">
            <div className="flex h-16 items-center border-b px-6 dark:border-zinc-800 gap-2">
                ...
                <span className="text-lg text-black dark:text-white font-bold">Driver Panel</span>
            </div>
